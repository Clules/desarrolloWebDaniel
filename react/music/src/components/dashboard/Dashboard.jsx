        ...
        <div className="absolute inset-0 flex flex-row">
          <div className="flex flex-col text-center h-screen justify-evenly md:items-center text-black w-1/6 pl-2 ">
            <div className="h-1/6 w-full bg-zinc-900 mx-1 mt-2 mb-1 shadow-xl rounded-md flex flex-col justify-around py-9">
              <button className="relative rounded-lg px-1 py-3 my-1 mx-0 h-10 flex flex-row text-white stroke-white fill-white hover:text-green-500 hover:fill-green-500 hover:stroke-green-500 hover:underline">
                <svg
                ...
                <p className="text-xs font-normal text-left align-middle">
                  Home
                </p>
              </button>
              <button className="relative rounded-lg px-1 py-3 my-1 mx-0 h-10 flex flex-row text-white stroke-white fill-white hover:text-green-500 hover:fill-green-500 hover:stroke-green-500 hover:underline">
            ...
            <div className="h-5/6 w-full bg-zinc-900 mx-1 mt-1 mb-2 shadow-xl rounded-md ">
              <div className="relative rounded-lg px-1 py-0 my-2 mx-0 h-2/12 flex flex-row items-stretch text-white stroke-white fill-white hover:text-green-500 hover:fill-green-500 hover:stroke-green-500 hover:underline">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 50 50"
                ...
                <p className="text-xs font-normal text-left mt-3.5 w-full">
                  Your Library
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col text-center  h-screen justify-evenly md:items-center text-black w-4/6  pl-2">
            <div className="h-full w-full bg-zinc-900 mx-1 my-2 shadow-xl rounded-md p-5">
              ...
              <div className="flex flex-col justify-around mt-10 overflow-scroll h-100">
                <div className="text-white text-lg">
                  {songs.map((song) => (
                    <div key={song.name} className="flex flex-row">
                      <img src={song.image} alt={song.name} className="w-24" />
                      <div>{song.name}</div>
                      <div>{song.artist}</div>
                      <div>{song.album}</div>
                    </div>
