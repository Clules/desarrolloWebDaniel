      ...
      >
        <div className="absolute inset-0 flex flex-row">
          <div className="flex flex-col text-center h-screen justify-evenly md:items-center text-black w-1/6 pl-2 ">
            ...
            <div className="h-5/6 w-full bg-zinc-900 mx-1 mt-1 mb-2 shadow-xl rounded-md flex flex-col justify-start pb-5 pt-2">
              {/*library div */}
              <div className="relative rounded-lg w-full px-1 py-0 my-2 mx-0 h-2/12 flex flex-row justify-between">
                ...
                <button className="text-xs stroke-white fill-white hover:fill-green-500 hover:stroke-green-500">
                  <svg
                    width="12px"
                    height="12px"
                    viewBox="0 0 24 24"
